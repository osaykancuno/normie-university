...
error SkillAI__ValidationNotRequested(bytes32 dataHash);
error SkillAI__ValidationAlreadyCompleted(bytes32 dataHash);
error SkillAI__NotRequestedValidator(address caller, address expected);
error SkillAI__ValidatorNotAuthorized(address validator);
error SkillAI__InvalidValidationResponse(uint8 response);
error SkillAI__NotCompleted(address agent, uint256 skillId);
error SkillAI__AlreadyRated(address agent, uint256 skillId);
error SkillAI__UsdcNotSupported(uint256 skillId);
error SkillAI__UsdcNotConfigured();
error SkillAI__RefundNotReady(uint256 availableAt);
error SkillAI__PathNotFound(uint256 pathId);
